...
class MSSample(MaterialSample):
    ...
    """
    linkml_meta: ClassVar[LinkMLMeta] = LinkMLMeta({'abstract': True, 'from_schema': 'https://w3id.org/NFDI4Chem/ms-dcat-ap'})
...
class MassSpectrometer(Device):
    ...
    manufacturer: Manufacturer = Field(default=..., description="""The manufacturer of the mass spectrometer.""", json_schema_extra = { "linkml_meta": {'domain_of': ['MassSpectrometer'], 'is_a': 'has_qualitative_attribute'} })
    model: Model = Field(default=..., description="""The model designation of the mass spectrometer.""", json_schema_extra = { "linkml_meta": {'domain_of': ['MassSpectrometer'], 'is_a': 'has_qualitative_attribute'} })
    mass_analyzer_type: MassAnalyzerType = Field(default=..., description="""The type of mass analyzer used in the mass spectrometer.""", json_schema_extra = { "linkml_meta": {'domain_of': ['MassSpectrometer'], 'is_a': 'has_qualitative_attribute'} })
    ionization_type: IonizationType = Field(default=..., description="""The type of ionization used in the mass spectrometer.""", json_schema_extra = { "linkml_meta": {'domain_of': ['MassSpectrometer'], 'is_a': 'has_qualitative_attribute'} })
    detector_type: Optional[DetectorType] = Field(default=None, description="""The type of detector used in the mass spectrometer.""", json_schema_extra = { "linkml_meta": {'domain_of': ['MassSpectrometer'], 'is_a': 'has_qualitative_attribute'} })
    id: str = Field(default=..., description="""A slot to provide an URI for an entity within this schema.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Activity',
                       'AgenticEntity',
                       'Dataset',
                       'DefinedTerm',
...
class MassSpectrometry(DataGeneratingActivity):
    ...
    acquisition_mode: AcquisitionMode = Field(default=..., description="""The acquisition mode used during the mass spectrometry measurement.""", json_schema_extra = { "linkml_meta": {'domain_of': ['MassSpectrometry'], 'is_a': 'has_qualitative_attribute'} })
    scan_polarity: ScanPolarity = Field(default=..., description="""The scan polarity used during the mass spectrometry measurement.""", json_schema_extra = { "linkml_meta": {'domain_of': ['MassSpectrometry'], 'is_a': 'has_qualitative_attribute'} })
    scan_window_lower_limit: ScanWindowLowerLimit = Field(default=..., description="""The lower limit of the scan window used during the measurement, typically expressed in m/z.""", json_schema_extra = { "linkml_meta": {'domain_of': ['MassSpectrometry'], 'is_a': 'has_quantitative_attribute'} })
    scan_window_upper_limit: ScanWindowUpperLimit = Field(default=..., description="""The upper limit of the scan window used during the measurement, typically expressed in m/z.""", json_schema_extra = { "linkml_meta": {'domain_of': ['MassSpectrometry'], 'is_a': 'has_quantitative_attribute'} })
